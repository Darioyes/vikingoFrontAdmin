...
@Component({
  selector: 'app-detail-indirect-costs',
  imports: [
    CommonModule,
    RouterModule,
    DecimalPipe,
  ...
  templateUrl: './detail-indirect-costs.component.html',
  styleUrl: './detail-indirect-costs.component.scss'
})
export class DetailIndirectCostsComponent implements OnInit, OnDestroy {
